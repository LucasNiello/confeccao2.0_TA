...
<div class="max-w-lg">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-xl font-bold text-gray-800">Nova Categoria</h2>
    </div>
    <div class="bg-white rounded-xl shadow-sm p-6">
        <form method="POST" action="{{ route('categorias.store') }}" class="space-y-4">
            @csrf
            <x-input-field label="Nome da categoria" name="nome" required />
            <div>
            ...
            <div class="flex justify-end gap-3 pt-4 border-t">
                ...
                <x-btn-primary>Salvar Categoria</x-btn-primary>
            </div>
        </form>
    </div>
</div>
